...
registerOnClick('Plane.001', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty', 'Plane.001', 1, function() {}, 0);
}, function(event) {});
registerOnClick('Plane.002', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty', 'Plane.002', 1, function() {}, 0);
}, function(event) {});
registerOnClick('Plane.004', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty', 'Plane', 1, function() {}, 0);
}, function(event) {});
registerOnClick('Cube.003', false, false, [0,1,2], false, function(event) {
    tweenCamera('Empty', 'Plane.004', 1, function() {}, 0);
}, function(event) {});
